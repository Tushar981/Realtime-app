...
var addToCart = document.querySelectorAll('.add-to-cart'); //let cartCounter = document.getElementById('#cart-counter');
...
addToCart.forEach(function (btn) {
  btn.addEventListener('click', function (e) {
    var pizza = JSON.parse(btn.dataset.pizza); // object to JSON conversion
    //console.log(pizza);

    updateCart(pizza);
  });
});
(0,_admin__WEBPACK_IMPORTED_MODULE_1__["default"])(); //change order status
